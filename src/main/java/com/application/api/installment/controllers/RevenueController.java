...
public class RevenueController {
    ...
    @GetMapping
    public ResponseEntity<List<RevenueResponseDTO>> getRevenues(@RequestParam(value = "search", required = false) String search) {
        List<Revenue> revenues = revenueService.getRevenues(search);
